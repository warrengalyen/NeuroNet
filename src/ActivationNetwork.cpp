...
NeuroNet::ActivationNetwork::ActivationNetwork(IActivationFunction *function, int inputsCount, int *neuronCounts) :
...
NeuroNet::ActivationNetwork::~ActivationNetwork()
{
	for (int i = 0; i < this->layerCount; i++)
	{
		delete layers[i];
