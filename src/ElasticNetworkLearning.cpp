...
NeuroNet::ElasticNetworkLearning::ElasticNetworkLearning(DistanceNetwork *network)
{
...
NeuroNet::ElasticNetworkLearning::~ElasticNetworkLearning()
{
	delete distance;
}

double NeuroNet::ElasticNetworkLearning::Run(double *input)
{
	double error = 0.0;
...
double NeuroNet::ElasticNetworkLearning::RunEpoch(double **input)
{
...
double NeuroNet::ElasticNetworkLearning::LearningRate() const
{
	return this->learningRate;
}

void NeuroNet::ElasticNetworkLearning::LearningRate(const double rate)
{
	this->learningRate = MAX(0.0, MIN(1.0, rate));
}

double NeuroNet::ElasticNetworkLearning::LearningRadius() const
{
	return this->learningRadius;
}

void NeuroNet::ElasticNetworkLearning::LearningRadius(const double rate)
{
